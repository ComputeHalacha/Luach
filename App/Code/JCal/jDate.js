...
export default class jDate {
    ...
    getAllDetails(location) {
        const list = [],
            ...
            feet =
                (location.Elevation * 3.28084).toFixed(0).toString() + ' ft.',
        ...
        addItem(
            'Alos Hashachar - 72',
            Utils.getTimeString(
                Utils.addMinutes(sunriseMishor, -72),
                false,
                true
            )
        );
        ...
        if (sunrise && sunset) {
            ...
            addItem(
                'Mincha Ktanah',
                Utils.getTimeString(
                    Utils.addMinutes(sunriseMishor, shaaZmanis * 9.5)
                )
            );
            addItem(
                'Plag Hamincha',
                Utils.getTimeString(
                    Utils.addMinutes(sunriseMishor, shaaZmanis * 10.75)
                )
            );
        }
        if (!sunset) {
            ...
            if (
                Utils.totalMinutes(sunset) === Utils.totalMinutes(sunsetMishor)
            ) {
                addItem(
                    'Shkias Hachama - Sunset',
                    Utils.getTimeString(sunset),
                    true
                );
            } else {
                addItem(
                    'Sunset at Sea Level',
                    Utils.getTimeString(sunsetMishor)
                );
                addItem(
                    'Shkiah (at ' + feet + ')',
                    Utils.getTimeString(sunset),
            ...
            addItem(
                '72 \'Zmaniot MA\'',
                Utils.getTimeString(
                    Utils.addMinutes(sunset, shaaZmanisMga * 1.2)
                )
            );
        }
        return list;
    ...
    getAllDetailsList(location) {
        ...
        if (!sunset) {
            ...
            addItem(
                '72 \'Zmaniot MA\'',
                Utils.getTimeString(
                    Utils.addMinutes(sunset, shaaZmanis90 * 1.2)
                )
            );
        }
        return list;
    ...
    static getHolidays(jd, israel, hebrew) {
        ...
        if (jDay === 30) {
            const monthIndex =
                (jMonth === 12 && !isLeapYear) || jMonth === 13
                    ? 1
                    : jMonth + 1;
            list.push(
                !hebrew
        ...
        switch (jMonth) {
            case 1: //Nissan
                if (jDay === 12 && dayOfWeek === 4)
                    ...
                    list.push(
                        !hebrew ? 'First Day of Pesach' : 'פסח - יום ראשון'
                    );
                else if (jDay === 16)
                    list.push(
                        israel
            ...
            case 4: //Tamuz
                if (jDay === 17 && dayOfWeek !== 6) {
                    list.push(
                        !hebrew ? 'Fast - 17th of Tammuz' : 'צום י"ז בתמוז'
                    );
            ...
            case 7: //Tishrei
                if (jDay === 1)
                    list.push(
                        !hebrew ? 'Rosh Hashana - First Day' : 'ראש השנה'
                    );
                else if (jDay === 2)
                    list.push(
                        !hebrew ? 'Rosh Hashana - Second Day' : 'ראש השנה'
                    );
            ...
            case 9: //Kislev
                if (jDay === 25)
                    list.push(
                        !hebrew ? 'Chanuka - One Candle' : '\'חנוכה - נר א'
                    );
                else if (jDay === 26)
                    list.push(
                        !hebrew ? 'Chanuka - Two Candles' : '\'חנוכה - נר ב'
                    );
                else if (jDay === 27)
                    list.push(
                    ...
                    list.push(
                        !hebrew ? 'Chanuka - Four Candles' : '\'חנוכה - נר ד'
                    );
                else if (jDay === 29)
                    list.push(
                        !hebrew ? 'Chanuka - Five Candles' : '\'חנוכה - נר ה'
                    );
                else if (jDay === 30)
                    list.push(
            ...
            case 10: //Teves
                if (jDate.isShortKislev(jYear)) {
                    if (jDay === 1)
                        ...
                        list.push(
                            !hebrew
                                ? 'Chanuka - Seven Candles'
                                : '\'חנוכה - נר ז'
                        );
                    else if (jDay === 3)
                        list.push(
                            !hebrew
                                ? 'Chanuka - Eight Candles'
                                : '\'חנוכה - נר ח'
                        );
                } else {
                    if (jDay === 1)
                ...
                if (jDay === 10)
                    list.push(
                        !hebrew ? 'Fast - 10th of Teves' : 'צום עשרה בטבת'
                    );
                break;
            case 11: //Shvat
            ...
            case 13:
                if (jMonth === 12 && isLeapYear) {
                    ...
                    if (jDay === 11 && dayOfWeek === 4)
                        list.push(
                            !hebrew ? 'Fast - Taanis Esther' : 'תענית אסתר'
                        );
