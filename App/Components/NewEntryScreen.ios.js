            ...
            <View style={{ flexDirection: 'row', flex: 1 }}>
                ...
                <ScrollView style={{ flex: 1 }}>
                    <View style={GeneralStyles.formRow}>
                        ...
                        <Select
                            onSelect={value =>
                                this.setState({ jdate: new jDate(jdate.Year, jdate.Month, value) })}
                    ...
                    <View style={GeneralStyles.formRow}>
                        ...
                        <Select
                            onSelect={value =>
                                this.setState({ jdate: new jDate(jdate.Year, value, jdate.Day) })}
                    ...
                    <View style={GeneralStyles.formRow}>
                        ...
                        <Select
                            onSelect={value =>
                                this.setState({ jdate: new jDate(value, jdate.Month, jdate.Day) })}
                    ...
                    <View style={GeneralStyles.formRow}>
                        ...
                        <Select
                            onSelect={value => this.setState({ nightDay: value })}
                            defaultText={this.state.nightDay === NightDay.Night ? 'Night' : 'Day'}
                            style={GeneralStyles.select}
                            indicator='down'
                            transparent={true}
                            backdropStyle={GeneralStyles.optionListBackdrop}
