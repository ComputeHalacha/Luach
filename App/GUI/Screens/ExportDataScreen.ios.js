    ...
    switch (this.state.dataSet) {
      ...
      case "Events":
        ...
        for (let occ of this.appData.UserOccasions) {
          csv += `"${occ.jdate.toShortString(
            false
          )}","${occ.sdate.toLocaleDateString()}","${occ.toString(true)}","${
            occ.comments
          }","${occ.color}"\r\n`;
        }
        break;
      ...
      case "Settings": {
        ...
        csv =
          ...
          )}","${yon(settings.fourDaysHefsek)}","${yon(
          ...
          `,"${yon(settings.hideHelp)}","${yon(settings.discreet)}","${yon(
            settings.requirePIN
          )}"\r\n`;
        break;
      }
    ...
    switch (this.state.dataSet) {
      ...
      case "Settings": {
        html +=
          ...
          `<p><b>Discreet</b><br />${yon(settings.discreet)}<hr /></p>` +
          ...
          <ScrollView style={{ flex: 1 }}>
            <View style={GeneralStyles.formRow}>
              ...
              >
                ...
                <Option value="Flagged Dates">Flagged Dates</Option>
